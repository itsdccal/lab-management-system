...
import { Upload, FileText, Folder, Download, CheckCircle } from 'lucide-react';

const AssistantMaterialsPage = () => {
  const features = [
  ...
  return (
    <div className="p-6 space-y-6 min-h-screen">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Materi</h1>
        <p className="text-gray-300">Module upload & content organization</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-slate-800/30 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
          ...
          <p className="text-gray-300 text-sm">Total Materials</p>
        </div>
      ...
      <div className="bg-slate-800/20 backdrop-blur-xl border border-slate-700/30 rounded-2xl p-8 text-center">
        ...
        <h3 className="text-xl font-bold text-white mb-2">Material Management Coming Soon</h3>
        <p className="text-gray-400">Advanced material upload features under development!</p>
...
export default AssistantMaterialsPage;