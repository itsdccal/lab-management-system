...
const SessionsPage = () => {
  ...
  return (
    <div className="p-6 space-y-6 min-h-screen">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Sesi Praktikum</h1>
        <p className="text-gray-300">Lab session & attendance management</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-slate-800/30 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
          ...
          <h3 className="text-lg font-bold text-white">2.5</h3>
          <p className="text-gray-300 text-sm">Hours/Session</p>
        </div>
      ...
      <div className="bg-slate-800/20 backdrop-blur-xl border border-slate-700/30 rounded-2xl p-8 text-center">
        ...
        <h3 className="text-xl font-bold text-white mb-2">Session Management Coming Soon</h3>
        <p className="text-gray-400">Advanced session management features under development!</p>
