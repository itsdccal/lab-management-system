...
import { BookOpen, Download, FileText, Video, CheckCircle } from 'lucide-react';
...
const StudentMaterialsPage = () => {
  ...
  return (
    <div className="p-6 space-y-6 min-h-screen">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Materi Pembelajaran</h1>
        <p className="text-gray-300">Download materials & resources</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-slate-800/30 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
          ...
          <p className="text-gray-300 text-sm">Available Modules</p>
        </div>
        ...
        <div className="bg-slate-800/30 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
          ...
          <p className="text-gray-300 text-sm">Video Tutorials</p>
        </div>
      ...
      <div className="bg-slate-800/20 backdrop-blur-xl border border-slate-700/30 rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-400">Learning materials management under development!</p>
