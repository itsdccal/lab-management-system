...
const StudentAssignmentsPage = () => {
  ...
  return (
    <div className="p-6 space-y-6 min-h-screen">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Tugas & Praktikum</h1>
        <p className="text-gray-300">Submit assignments & track progress</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-slate-800/30 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
          ...
          <h3 className="text-lg font-bold text-white">7</h3>
        ...
        <div className="bg-slate-800/30 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
          ...
          <h3 className="text-lg font-bold text-white">2</h3>
          <p className="text-gray-300 text-sm">Due This Week</p>
        </div>
      </div>
      ...
      <div className="bg-slate-800/20 backdrop-blur-xl border border-slate-700/30 rounded-2xl p-8 text-center">
        ...
        <h3 className="text-xl font-bold text-white mb-2">Assignment System Coming Soon</h3>
        <p className="text-gray-400">Full assignment management under development!</p>
